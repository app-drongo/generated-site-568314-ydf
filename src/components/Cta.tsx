...
export default function CTA() {
  const stats = [
    ...
    { value: "500+", label: "Handcrafted Designs", icon: Zap },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join thousands of fashion-conscious customers who have chosen our
                Maroquinerie Artisanale platform. Start your journey today with a
                free trial and experience the difference.
              </p>
